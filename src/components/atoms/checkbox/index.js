    ...
    return (
        <label className={twMerge(`flex items-center ${mainClass}`)}>
            <input
                ...
                {...props}
            />
            <label class="flex items-center justify-center h-5 w-5 bg-white border border-gray-300 cursor-pointer group focus:outline-none peer-checked:bg-primary-main peer-checked:border-primary-main" for={id}>
